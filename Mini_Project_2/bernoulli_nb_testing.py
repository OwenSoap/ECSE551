# -*- coding: utf-8 -*-
"""Bernoulli NB Testing.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/199uJ4b4t-1xxUSn2onGApxLUPMPofQDt

<center><h1>Mini Project 2 - Bernoulli Naïve Bayes</h1>
<h4>This file tests the performance of the Bernoulli Naïve Bayes implemented by ourselves.</h4></center>
...
def count_vec_with_sw(X_train, X_test, max_features):
...
kf = KFold(n_splits=5, shuffle=True)
for train_index, test_index in kf.split(X):
    vectors_train, vectors_test = count_vec_with_sw(X[train_index], X[test_index], max_features=True)
    clf.fit(vectors_train, y[train_index])
    a_s = metrics.accuracy_score(y[test_index], clf.predict(vectors_test))
    print(a_s)
    accuracies.append(a_s)

print("\t- Bernoulli Naïve Bayes + CountVectorizer with stop word, Max Features = 5000 -\nAccuracy: {}%\tTime Spent: {}s".format(np.mean(accuracies), time()-tic))
...
print("\t- Bernoulli Naïve Bayes + CountVectorizer with stop word -\nAccuracy: {}%\tTime Spent: {}s".format(np.mean(accuracies), time()-tic))
...
print("\t- Bernoulli Naïve Bayes + CountVectorizer with stem tokenizer -\nAccuracy: {}%\tTime Spent: {}s".format(np.mean(accuracies), time()-tic))
...
print("\t- Bernoulli Naïve Bayes + CountVectorizer with lemma tokenizer -\nAccuracy: {}%\tTime Spent: {}s".format(np.mean(accuracies), time()-tic))